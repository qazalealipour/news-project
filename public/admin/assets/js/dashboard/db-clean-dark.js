(function ($) {
    ...
    setTimeout(function () {
        new Noty({
            text: '<div class="text-center">منتظر باشید! سین بورد کامل بارگذاری شود.</div>',
            type: 'notification',
            layout: 'topRight',
            timeout: 3000,
            animation: {
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderWidth: 4,
                data: [70, 80, 105, 90, 120, 110,135, 125, 140, 130, 145, 135]
            },
                {
                    label: "ویزیت شده",
                    borderColor: "#aea9c3",
                    ...
                    borderWidth: 3,
                    borderDash: [10, 5],
                    data: [90, 100, 80, 120, 100, 110,90, 130, 110, 100, 120, 130]
                }
            ]
        },
        options: {
    ...
    var firstIcon = L.icon({
        iconUrl: 'assets/img/avatar/avatar-03.jpg',
    ...
    var thirdIcon = L.icon({
        iconUrl: 'assets/img/avatar/avatar-01.jpg',
        iconSize: [80, 80], // size of the icon
    });

    var firstPopup = "محمد نوری <span class='badge-text badge-text-small info ml-2'>پرداخت شده</span>";
    var secondPopup = "علی نیکو <span class='badge-text badge-text-small danger ml-2'>کنسل شده</span>";
    var thirdPopup = "مرتضی رضائی <span class='badge-text badge-text-small info ml-2'>پرداخت شده</span>";

    L.marker([35.700, 51.401], {icon: firstIcon}).bindPopup(firstPopup).addTo(cities);
    L.marker([35.688, 51.415], {icon: secondIcon}).bindPopup(secondPopup).addTo(cities);
    L.marker([35.710, 51.429], {icon: thirdIcon}).bindPopup(thirdPopup).addTo(cities);
