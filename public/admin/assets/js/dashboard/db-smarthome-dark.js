(function ($) {
	...
	function getDate() {
        ...
        var weekdayNames = ["شنبه", "یک شنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه"]
        var ampm = " شب ";
	...
	$('.widget29').owlCarousel({
		...
		loop: true,
		smartSpeed:500,
		navText: ['<i class="ion-chevron-right" aria-hidden="true"></i>', '<i class="ion-chevron-left" aria-hidden="true"></i>'],
		responsive:{
			0:{
				items:1,
				nav:false
