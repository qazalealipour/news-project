 ...
 *   https://datatables.net/download/#bs4/jq-3.2.1/dt-1.10.16/b-1.5.1/b-flash-1.5.1/cr-1.4.1
 *
 * Included libraries:
 *   jQuery 3 3.2.1, DataTables 1.10.16, Buttons 1.5.1, Flash export 1.5.1, ColReorder 1.4.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(فیلتر شده از _MAX_ مچموع ورودی)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "هیج رکوردی پیدا نشد"
		},
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/jq-3.2.1/dt-1.10.16/b-1.5.1/b-flash-1.5.1/cr-1.4.1",
...
$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo, drop, invalidateRows )
{
	...
	/* Reposition the header elements in the header layouts array */
